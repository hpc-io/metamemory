...
int main(int argc, char *argv[]) {
  ...
  meta_h_A->fn->alloc(meta_h_A, numElements, sizeof(float), MEM_CPU_PINNED, MEM_GPU);
  meta_h_B->fn->alloc(meta_h_B, numElements, sizeof(float), MEM_CPU_PINNED, MEM_GPU);
  meta_h_C->fn->alloc(meta_h_C, numElements, sizeof(float), MEM_CPU_PINNED, MEM_GPU);
