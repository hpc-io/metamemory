...
int main(int argc, char *argv[]) {
  ...
  mem* h_A = mem_alloc(numElements, sizeof(float), METAMEM_POSIX, MEM_CPU_PAGEABLE);
  mem* h_B = mem_alloc(numElements, sizeof(float), METAMEM_POSIX, MEM_CPU_PAGEABLE);
  mem* h_C = mem_alloc(numElements, sizeof(float), METAMEM_POSIX, MEM_CPU_PAGEABLE);
